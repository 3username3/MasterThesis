...
if __name__ == "__main__":
    ...
    def objective(trial):
        ...
        naive_model.fit(series=syn_load_train)

        trial_number = len(study.trials)
        model_name = f"dlinear_model_trial{trial_number}"

        backtest_naive, backtest_metrics, load_series = evaluation(syn_load_val, naive_model, syn_future_covs_val, measurements_per_day)
