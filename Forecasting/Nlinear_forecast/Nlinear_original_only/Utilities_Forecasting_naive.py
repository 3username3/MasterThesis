...
def read_in_data(file_orig_data, xth_observation_orig):
    ...
    original_data = original_data[:52560]
    ...
    date_df = original_df["SETTLEMENTDATE"]
...
def evaluation(load, model, date_df, future_covariates, model_name, data_points):
    ...
    list_metrics = [gmae_backtest, mdae_backtest, mae_backtest, mase_backtest, mape_backtest]
