...
def data_preparation_energy_data(file_name, number_examples, max_sequence_length, number_features, use_xth_observation):
    ...
    data_df = data_df.drop(columns=["REGION", "RRP", "SETTLEMENTDATE", "precipitation", "relative_humidity","soil_water_content","solar_radiation","wind_speed"])
...
def objective(trial):
    ...
    score = Metrics.evaluate(
        ...
        random_state=0,
        workspace="/home/ai21m017/datasets/TrialSeries1/PublicHolidays/workspace",
        use_cache=True
    )
