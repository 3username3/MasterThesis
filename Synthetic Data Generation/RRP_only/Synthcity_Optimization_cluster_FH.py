...
def data_preparation_energy_data(file_name, number_examples, max_sequence_length, number_features, use_xth_observation):
    ...
    data_df = data_df.drop(columns=["REGION", "relative_humidity", "SETTLEMENTDATE", "precipitation", "public_holidays","temperature","soil_water_content","wind_speed", "solar_radiation"])
...
def objective(trial):
    ...
    date_column, data_linear, data = data_preparation_energy_data("/home/ai21m017/datasets/train_energy_temp_data_NSW_values_per_day_24.csv", 13, 2190, 2, 4)
    ...
    score = Metrics.evaluate(
        ...
        random_state=0,
        workspace="/home/ai21m017/datasets/TrialSeries1/RRP_only/workspace",
        use_cache=True
    )
